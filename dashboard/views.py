...
def careers(request):
    return render(
        request,
        'dashboard/careers.html'
    )

def privacy_policy(request):
    return render(
        request,
        'dashboard/privacy_policy.html'
    )

def terms_of_use(request):
    return render(
        request,
        'dashboard/terms_of_use.html'
    )

def cookies_policy(request):
    return render(
        request,
        'dashboard/cookies_policy.html'
    )

def accessibility(request):
    return render(
        request,
        'dashboard/accessibility.html'
    )